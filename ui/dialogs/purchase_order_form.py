...
class PurchaseOrderFormDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        po_info_widget = QWidget()
        po_info_layout = QVBoxLayout(po_info_widget)
        po_info_layout.setContentsMargins(0, 0, 0, 0)
        
        self.po_num_val = QLabel("WILL BE ASSIGNED")
        self.po_num_val.setStyleSheet("font-weight: bold; color: #666; font-style: italic;")
        po_info_layout.addWidget(self.po_num_val)
        
        po_hint = QLabel("(Autogenerated upon saving)")
        po_hint.setStyleSheet("font-size: 9px; color: gray;")
        po_info_layout.addWidget(po_hint)
        
        right_side.addRow("PO Number:", po_info_widget)
        
        self.status_combo = QComboBox()
        self.status_combo.addItems(["Draft", "Approved", "Received"])
        self.status_combo.setCurrentText("Draft")
        self.status_combo.setStyleSheet(f"font-weight: bold; color: {Theme.PRIMARY};")
        right_side.addRow("Status:", self.status_combo)
    ...
    def get_data(self):
        ...
        return {
            ...
            "status": status_map.get(self.status_combo.currentText(), "draft"),
            "items": [
                {
